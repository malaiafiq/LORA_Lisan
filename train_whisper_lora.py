...
def compute_metrics(eval_pred):
    ...
    # WER will be computed separately in the custom evaluation
    return {}


def main():
    # Configuration - Change this to your JSON file path
    DATA_JSON_PATH = "/Volumes/Lisan/organized_dataset.json"  # Update this path to your JSON file
    ...
    # Define training hyperparameters and settings with early stopping
